========================================================================
   APLICACIÓN: Proyecto02 Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Proyecto02.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Proyecto02.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Proyecto02.pch y un archivo de tipos 
